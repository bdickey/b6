...
const SCHEMES: Scheme[] = [
  {
    name: 'Gold',
    border: '#C8A020',
    bg: 'linear-gradient(180deg, #2A1C06 0%, #160E02 100%)',
    handleBg: 'linear-gradient(180deg, #3C2A0A, #2A1C06)',
    strip: 'linear-gradient(90deg, transparent, #C8A020 20%, #FFE060 50%, #C8A020 80%, transparent)',
    btnBg: 'linear-gradient(180deg, #382408 0%, #221604 100%)',
    btnColor: '#C8A020',
    activeColor: '#4DB86A',
    ledText: '#FFB000',
    ledBg: '#120A00',
    ...
    speaker: '#160E02',
    speakerShadow: 'inset 0 0 0 3px #C8A020, inset 0 0 0 8px #160E02, inset 0 0 0 11px #8A6010, inset 0 0 0 14px #160E02, inset 0 0 0 17px #5A4010, inset 0 0 0 23px #160E02',
    cassetteBg: '#0E0802',
    reelBorder: '#5A4010',
    reelBg: '#241606',
  ...
  },
  {
    name: 'Galactic',
    border: '#4080C0',
    bg: 'linear-gradient(180deg, #060E30 0%, #020614 100%)',
    handleBg: 'linear-gradient(180deg, #0A143E, #060E30)',
    strip: 'linear-gradient(90deg, transparent, #4080C0 20%, #80C0FF 50%, #4080C0 80%, transparent)',
    btnBg: 'linear-gradient(180deg, #0C1A40 0%, #070E24 100%)',
    btnColor: '#60A0E0',
    activeColor: '#40E0A0',
    ledText: '#60C0FF',
    ledBg: '#020818',
    ...
    speaker: '#040A20',
    speakerShadow: 'inset 0 0 0 3px #4080C0, inset 0 0 0 8px #040A20, inset 0 0 0 11px #204860, inset 0 0 0 14px #040A20, inset 0 0 0 17px #102840, inset 0 0 0 23px #040A20',
    cassetteBg: '#02040E',
    reelBorder: '#102840',
    reelBg: '#0A1028',
  ...
  },
  {
    name: 'Fuchsia',
    border: '#E040A0',
    bg: 'linear-gradient(180deg, #220628 0%, #100214 100%)',
    handleBg: 'linear-gradient(180deg, #300A38, #220628)',
    strip: 'linear-gradient(90deg, transparent, #E040A0 20%, #FF80D0 50%, #E040A0 80%, transparent)',
    btnBg: 'linear-gradient(180deg, #300832 0%, #1C0420 100%)',
    btnColor: '#E060B0',
    activeColor: '#40E080',
    ledText: '#FF80D0',
    ledBg: '#14001A',
    ...
    speaker: '#140018',
    speakerShadow: 'inset 0 0 0 3px #E040A0, inset 0 0 0 8px #140018, inset 0 0 0 11px #601040, inset 0 0 0 14px #140018, inset 0 0 0 17px #400828, inset 0 0 0 23px #140018',
    cassetteBg: '#0C000E',
    reelBorder: '#400828',
    reelBg: '#200420',
